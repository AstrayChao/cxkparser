...
def main():
    ...
    parse_args.add_argument('--output', '-o', default=None,
                            required=True, type=str, help="Please input the output directory and file name of the file. e.g. /home/cxkparser/file_name. If you do not input the file name, the default file name is annotation_<original file name> ")
